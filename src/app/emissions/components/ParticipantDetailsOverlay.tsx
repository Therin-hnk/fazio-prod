            ...
            >
              ...
              {/* Bouton de vote */}
              {
                isAvailable ? (
                  ...
                  <div
                    className="bg-gray-400 text-white text-sm px-4 py-2 rounded-full flex items-center gap-2 shadow-lg backdrop-blur-sm bg-opacity-80 cursor-not-allowed"
                    title="Le vote n'est pas disponible pour ce participant en ce moment."
                  >
                    Vote indisponible
                  </div>
                )
